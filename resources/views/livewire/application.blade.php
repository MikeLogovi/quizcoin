...
<div style="color:red">
    ...
    <!-- All Jquery -->
    <!-- ============================================================== -->
    <script src="/application/assets/plugins/jquery/jquery.min.js"></script>
    <!-- Bootstrap tether Core JavaScript -->
    <script src="/application/assets/plugins/bootstrap/js/tether.min.js"></script>
    <script src="/application/assets/plugins/bootstrap/js/bootstrap.min.js"></script>
    <!-- slimscrollbar scrollbar JavaScript -->
    <script src="/application/html/js/jquery.slimscroll.js"></script>
    <!--Wave Effects -->
    <script src="/application/html/js/waves.js"></script>
    <!--Menu sidebar -->
    <script src="/application/html/js/sidebarmenu.js"></script>
    <!--stickey kit -->
    <script src="/application/assets/plugins/sticky-kit-master/dist/sticky-kit.min.js"></script>
    <!--Custom JavaScript -->
    <script src="/application/html/js/custom.min.js"></script>
    <!-- ============================================================== -->
    <!-- This page plugins -->
    <!-- ============================================================== -->
    <!-- chartist chart -->
    <script src="/application/assets/plugins/chartist-js/dist/chartist.min.js"></script>
    <script src="/application/assets/plugins/chartist-plugin-tooltip-master/dist/chartist-plugin-tooltip.min.js"></script>
    <!--c3 JavaScript -->
    <script src="/application/assets/plugins/d3/d3.min.js"></script>
    <script src="/application/assets/plugins/c3-master/c3.min.js"></script>
    <!-- Chart JS -->
    <script src="/application/html/js/dashboard1.js"></script>
</div>
